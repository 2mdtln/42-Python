...
#                                                 +#+#+#+#+#+   +#+           #
#   Created: 2026/03/11 15:03:46 by mtaheri            #+#    #+#             #
#   Updated: 2026/03/11 15:07:55 by mtaheri           ###   ########.fr       #
#                                                                             #
# *************************************************************************** #


def main() -> None:
    users = [{"name": "mtaheri", "score": 3999,
             "active": True, "location": "k1m02s01"},
             {"name": "ybarut", "score": 3400,
              "active": True, "location": "k1m03s02"},
             {"name": "aldinc", "score": 4700,
              "active": True, "location": "k1m05s03"},
             {"name": "miskirik", "score": 9900,
              "active": False, "location": "SR"}]
    ...
    unique_achievements = {achievement["title"] for achievement
                           in achievements}
